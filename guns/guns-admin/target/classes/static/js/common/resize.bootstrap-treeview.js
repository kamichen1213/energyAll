...
(function ($, window, document, undefined) {
    ...
    _default.settings = {
        ...
        expandIcon: 'icon-sanjiaojiantouxiangyou',
        collapseIcon: 'icon-sanjiaojiantouxiangxia',
        emptyIcon: 'glyphicon',
        nodeIcon: '',
        selectedIcon: '',
        checkedIcon: 'icon-fuxuankuang-xuanzhongxian',
        uncheckedIcon: 'icon-fuxuankuang-weixuanze',
...
//            console.log('Error: node does not exist');
    ...
    Tree.prototype.buildStyle = function () {
        ...
        if (this.options.onhoverColor) {
            style += '.node-' + this.elementId + ':not(.node-disabled):hover{' +
                'color:' + this.options.onhoverFontColor + ';background-color:' + this.options.onhoverColor + ';' +
                    '}';
        }
    ...
    Tree.prototype.css = '.treeview .list-group-item{cursor:pointer}.treeview span.indent{margin-left:10px;margin-right:10px}.treeview span.iconfont{width:12px;margin-right:5px}.treeview .node-disabled{color:silver;cursor:not-allowed}'
